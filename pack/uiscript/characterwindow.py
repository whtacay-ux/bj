			...
			[
				...
				## Page Area
				{
					...
					[
						...
						## else:
						## Passive Expanded Button
						{ "name":"passive_expanded_btn", "type" : "image", "x":166, "y":107, "image" : ROOT_PATH+"passive_expanded_button_01.sub"},
							
						{ "name":"change_base_button",		"type" : "image",	"x":8, "y":107, "image" : ROOT_PATH+"old_level_btn_03.sub"},
						{ "name":"change_conqueror_button",	"type" : "image",	"x":87, "y":107, "image" : ROOT_PATH+"new_level_btn_03.sub"},
