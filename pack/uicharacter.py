...
class CharacterWindow(ui.ScriptWindow):
	...
	def __SetEmotionSlot(self):
		...
		for slot in (self.soloEmotionSlot, self.dualEmotionSlot, self.specialEmotionSlot):#ENABLE_EMOJI_UPDATE
	...
	def __ClickEmotionSlot(self, slotIndex):
		...
		if slotIndex > 50 and slotIndex < 101:#ENABLE_EMOJI_UPDATE
