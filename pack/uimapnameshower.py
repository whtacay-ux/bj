	...
	def __init__(self):
		if localeInfo.IsARABIC():
			self.MAP_NAME_IMAGE =	{
							...
							"metin2_map_a2_1": LOCALE_PATH+"a2_2.tga",
							...
							"metin2_map_n_desert_02": LOCALE_PATH+"desert2.tga",
							"metin2_map_n_flame_01" : LOCALE_PATH+"frame1.tga",
							"metin2_map_n_flame_02": LOCALE_PATH+"frame2.tga",
							"metin2_map_milgyo" : LOCALE_PATH+"milgyo.tga",
							"metin2_map_milgyo_a": LOCALE_PATH+"milgyo2.TGA",
							...
							"map_n_snowm_02": LOCALE_PATH+"snow2.tga",
							...
							"metin2_map_trent_a": LOCALE_PATH+"trent_a.tga",
							"metin2_map_trent02_a": LOCALE_PATH+"trent02_a.tga",
							"metin2_map_dd"	:	LOCALE_PATH+"devil_basement.tga",
							"metin2_map_devilsCatacomb"	:	LOCALE_PATH+"devil_basement.tga",
							"metin2_map_dd"	:	LOCALE_PATH+"devil_basement.tga",
							"metin2_map_WL_01" :	LOCALE_PATH+"wl.tga",
							"metin2_map_nusluck01":	LOCALE_PATH+"nusluck.tga",
						}
		else:
			self.MAP_NAME_IMAGE =	{
							"metin2_map_a1"  : LOCALE_PATH+"a1.tga",
