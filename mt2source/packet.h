...
enum
{
	...
	//	HEADER_CG_RUNUP_MATRIX_ANSWER	= 201,
		...
		HEADER_CG_BLACKJACK = 218,
		HEADER_GC_BLACKJACK = 219,
#endif
...
#ifdef ITJA_BLACKJACK_SYSTEM
typedef struct SPacketCGBlackjack
{
	BYTE header;
	BYTE subheader;
	long long llAmount;
...
typedef struct SPacketGCBlackjack
{
	BYTE header;
	BYTE subheader;
} TPacketGCBlackjack;

typedef struct SPacketGCBlackjackUpdate
{
	BYTE header;
	BYTE subheader;
	long long llBet;
	...
	BYTE bPlayerCardCount;
	BYTE bDealerCardCount;
	BYTE bPlayerCardCountHand2;
	BYTE bPlayerCards[10];
	BYTE bDealerCards[10];
	BYTE bPlayerCardsHand2[10];
} TPacketGCBlackjackUpdate;

typedef struct SPacketGCBlackjackResult
{
	BYTE header;
	BYTE subheader;
	BYTE bResult;
