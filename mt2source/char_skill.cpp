...
bool CHARACTER::LearnSkillByBook(DWORD dwSkillVnum, BYTE bProb)
{
	...
	{
		if (GetLevel() < PLAYER_MAX_LEVEL_CONST) { need_exp = 20000; }//@turkmmo15
...
bool CHARACTER::UseSkill(DWORD dwVnum, LPCHARACTER pkVictim, bool bUseGrandMaster)
{
	...
	if ((dwVnum == SKILL_GEOMKYUNG || dwVnum == SKILL_GWIGEOM) && !GetWear(WEAR_WEAPON))//@turkmmo10
		return false;
	...
	if (IS_SET(pkSk->dwFlag, SKILL_FLAG_SELFONLY))
		...
		ComputeSkill(dwVnum, pkVictim);
	else if (dwVnum == SKILL_PAERYONG)//@turkmmo33
		ComputeSkill(dwVnum, pkVictim);//@turkmmo33
...
bool CHARACTER::IsUsableSkillMotion(DWORD dwMotionIndex) const
{
	...
	{
		// ��ų��   ���罺ųID  �ڰ���ųID  ����ųID  ���罺ųID	������(WOLFMAN) ��ųID
		{   0,		0,			0,			0,			0		}, //  0
...
eMountType GetMountLevelByVnum(DWORD dwMountVnum, bool IsNew) // updated to 2014/12/10
{
	...
	case 20233: // Muffin Lv3 (yes skill, yes atk)
	case 20234: // Nugget Lv3 (yes skill, yes atk)
	case 20235: // Muffin Lv3 (yes skill, yes atk)
	case 20236: // Nugget Lv3 (yes skill, yes atk)
	case 20237: // Muffin Lv3 (yes skill, yes atk)
	case 20238: // Nugget Lv3 (yes skill, yes atk)
	case 20239: // Lightning Lv3 (yes skill, yes atk)
	case 20240: // Rumble Lv3 (yes skill, yes atk)
	case 20241: // Nugget Lv3 (yes skill, yes atk)
	case 20242: // Muffin Lv3 (yes skill, yes atk)
	case 20243: // Kizaghan Lv3 (yes skill, yes atk)
	case 20244: // Nirvana Lv3 (yes skill, yes atk)
	case 20245: // Samsara Lv3 (yes skill, yes atk)
	case 20246: // Manni Lv3 (yes skill, yes atk)
	case 20247: // Manu Lv3 (yes skill, yes atk)
	case 20248: // Toulouse Lv3 (yes skill, yes atk)
	case 20249: // Toulouse Lv3 (yes skill, yes atk)
	case 20250: // Lava Hell Lv3 (yes skill, yes atk)
	case 20251: // Ice Hell Lv3 (yes skill, yes atk)
	case 20252: // Magma Dragon Lv3 (yes skill, yes atk)
	case 20253:
	case 20254: // White Rabbit Lv3 (yes skill, yes atk)
	case 20255: // Moon Rabbit Lv3 (yes skill, yes atk)
	case 20256:
	case 20257: // Bernie Lv3 (yes skill, yes atk)
	case 20258: // Blue Barry Lv3 (yes skill, yes atk)
	case 20259: // Kerberos Gold Lv3 (yes skill, yes atk)
	case 20260: // Kerberos Silver Lv3 (yes skill, yes atk)
	case 20261:
	case 20262:
	case 20263: // Night Wing Lv3 (yes skill, yes atk)
	case 20264: // Dark Wing Lv3 (yes skill, yes atk)
	case 20265:
	case 20266:
	case 20267:
	case 20268:
