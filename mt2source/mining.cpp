...
namespace mining
{
...
#ifdef ENABLE_ORE_DROP_FROM_MINING
	...
	void CHEAT_MAX_PICK(LPCHARACTER ch, LPITEM item)
	{
		...
		ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("��� ���õ��� �ִ�(%d)�� �Ǿ����ϴ�."), Pick_GetCurExp(pick));
	}
	...
	void PracticePick(LPCHARACTER ch, LPITEM item)
	{
		...
		if (Pick_IsPracticeSuccess(pick))
		{
			...
			{
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("��̰� �ִ� ���õ��� �����Ͽ����ϴ�."));
				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("�����۸� ���� ���� ������ ��̷� ���׷��̵� �� �� �ֽ��ϴ�."));
			}
			else
			{
				Pick_IncCurExp(pick);

				ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("����� ���õ��� �����Ͽ����ϴ�! (%d/%d)"),
	...
	EVENTFUNC(mining_event)
	{
		...
		if (!load)
		{
			ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("���̻� ĳ�� �� �����ϴ�."));
			return 0;
		}
		...
		if (number(1, 100) <= iPct)
		{
			...
			ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("ä���� �����Ͽ����ϴ�."));
		}
		else
		{
			ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("ä���� �����Ͽ����ϴ�."));
