...
void CGuild::UseSkill(DWORD dwVnum, LPCHARACTER ch, DWORD pid)
{
	...
	case GUILD_SKILL_TELEPORT:
		...
		else
		{
			if (m_memberP2POnline.find(pid) != m_memberP2POnline.end())
			{
				...
				{
					ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> ��밡 %d ä�ο� �ֽ��ϴ�. (���� ä�� %d)"), pcci->bChannel, g_bChannel);
				}
				else
				{
	...
	default:
	{
		/*if (ch->GetPlayerID() != GetMasterPID())
		  {
		  ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> ����常 ��� ��ų�� ����� �� �ֽ��ϴ�."));
		  return;
		  }*/

		if (!UnderAnyWar())
		{
			ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> ��� ��ų�� ����� �߿��� ����� �� �ֽ��ϴ�."));
			return;
		}
...
bool CGuild::ChargeSP(LPCHARACTER ch, int iSP)
{
	...
	{
		ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> %u�� ��ŷ��� ȸ���Ͽ����ϴ�."), iSP);
	}
	return true;
}
...
void CGuild::RequestDepositMoney(LPCHARACTER ch, int iGold)
{
	...
	{
		ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> ����Ŀ� �̿����ֽʽÿ�"));
		return;
	}
...
void CGuild::RequestWithdrawMoney(LPCHARACTER ch, int iGold)
{
	...
	if (ch->GetPlayerID() != GetMasterPID())
	{
		ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> ��� �ݰ��� ����常 ����� �� �ֽ��ϴ�."));
		return;
	}
...
void CGuild::Invite(LPCHARACTER pchInviter, LPCHARACTER pchInvitee)
{
	...
	case GERR_COMMISSIONPENALTY:
		...
		return;
	case GERR_ALREADYJOIN:	pchInviter->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> ������ �̹� �ٸ� ��忡 �����ֽ��ϴ�.")); return;
	case GERR_GUILDISFULL:	pchInviter->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> �ִ� ���� ���� �ʰ��߽��ϴ�.")); return;
...
void CGuild::InviteAccept(LPCHARACTER pchInvitee)
{
	...
	case GERR_COMMISSIONPENALTY:
		pchInvitee->ChatPacket(CHAT_TYPE_INFO,
			...
			quest::CQuestManager::instance().GetEventFlag("guild_disband_delay"));
		return;
	case GERR_ALREADYJOIN:	pchInvitee->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> ������ �̹� �ٸ� ��忡 �����ֽ��ϴ�.")); return;
	case GERR_GUILDISFULL:	pchInvitee->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("<���> �ִ� ���� ���� �ʰ��߽��ϴ�.")); return;
