...
EVENTFUNC(battle_arena_event)
{
	...
	if (pInfo != NULL)
	{
		...
		{
			++pInfo->state;
			BroadcastNotice(LC_TEXT("���͵��� ���ݱ��� 5�� ���ҽ��ϴ�!!!"));
		}
		...
		{
			++pInfo->state;
			BroadcastNotice(LC_TEXT("���͵��� ���ݱ��� 1�� ���ҽ��ϴ�!!!"));
		}
		...
		case 3:
		{
			...
			{
				pInfo->state = 6;
				SendNoticeMap(LC_TEXT("�߾� ���ܿ� ���� ����� �𿩵�ϴ�."), pInfo->nMapIndex, false);
			}
			else
			{
				pInfo->wait_count++;
		...
		{
			pInfo->state++;
			SendNoticeMap(LC_TEXT("���͵��� �������� �����߽��ϴ�."), pInfo->nMapIndex, false);
			SendNoticeMap(LC_TEXT("��� �� ������ ���ư��ϴ�."), pInfo->nMapIndex, false);
		...
		case 6:
		{
			...
			SendNoticeMap(LC_TEXT("���͵��� ������ ��Ÿ�����ϴ�."), pInfo->nMapIndex, false);
		...
		case 7:
		{
			if (SECTREE_MANAGER::instance().GetMonsterCountInMap(pInfo->nMapIndex) <= 0)
			{
				SendNoticeMap(LC_TEXT("�͸���ֿ� ���� ���ϵ��� ��� �����ƽ��ϴ�."), pInfo->nMapIndex, false);
				SendNoticeMap(LC_TEXT("��� �� ������ ���ư��ϴ�."), pInfo->nMapIndex, false);
			...
			{
				SendNoticeMap(LC_TEXT("�͸���ְ� ���Ͽ����ϴ�."), pInfo->nMapIndex, false);
				SendNoticeMap(LC_TEXT("��� �� ������ ���ư��ϴ�."), pInfo->nMapIndex, false);
...
bool CBattleArena::Start(int nEmpire)
{
	...
	char szBuf[1024];
	snprintf(szBuf, sizeof(szBuf), LC_TEXT("%s�� ������ ���͵��� �����ϰ� �ֽ��ϴ�."), EMPIRE_NAME(m_nEmpire));
