...
ACMD(do_set)
{
	...
	case DoSetTypes::ALIGNMENT: // alignment
	{
		int	amount = 0;
		str_to_number(amount, arg3);
		tch->UpdateAlignment(amount - tch->GetRealAlignment());//@turkmmo6
	}
	break;
	}
...
/**
 * @version 05/06/08	Bang2ni - ��� ���ʽ� ����Ʈ ���� �ȵǴ� ���� ����.(��ũ��Ʈ�� �ۼ��ȵ�.)
 * 			          quest/priv_guild.quest �� ���� ��ũ��Ʈ �о���� ������
 */
ACMD(do_priv_guild)
{
...
ACMD(do_build)
{
	...
	case 'c':
	{
		...
		/*
		   ...
		   {
		   ch->ChatPacket(CHAT_TYPE_INFO, "�ǹ� ȸ�� ����� ���� �������� �ʽ��ϴ�");
		   return;
		   }
		 */
