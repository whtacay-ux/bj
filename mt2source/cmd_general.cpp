...
static const char* FN_point_string(int apply_number)
{
	...
	//case POINT_MALL_ITEMBONUS:		return LC_TEXT("������ ����� %.1f��");//@turkmmo45
	//case POINT_MALL_GOLDBONUS:		return LC_TEXT("�� ����� %.1f��");//@turkmmo45
	case POINT_MALL_ITEMBONUS:		return LC_TEXT("������ ����� %d��");//@turkmmo45
	case POINT_MALL_GOLDBONUS:		return LC_TEXT("�� ����� %d��");//@turkmmo45
...
ACMD(do_change_channel)
{
	...
	if (ch->m_pkTimedEvent)
	{
		ch->ChatPacket(CHAT_TYPE_INFO, LC_TEXT("Ae��O ��C��u��A��I��U."));
		event_cancel(&ch->m_pkTimedEvent);
		return;
	}
