...
namespace quest
{
	...
	ALUA(forked_init_kill_count_per_empire)
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
	...
	ALUA(forked_get_pass_path_my_empire)
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
	...
	ALUA(forked_is_registered_user)
	{
		LPCHARACTER ch = CQuestManager::instance().GetCurrentCharacterPtr();
	...
	ALUA(forked_purge_all_monsters)
	{
