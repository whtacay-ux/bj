...
int		save_event_second_cycle = passes_per_sec * 180;
int		ping_event_second_cycle = passes_per_sec * 180;
...
DWORD	g_dwItemBonusChangeTime = 0;
...
bool	g_bDisableEmpireLanguageCheck = true;
...
int VIEW_RANGE = 10000;
int VIEW_BONUS_RANGE = 500;

int g_server_id = 0;
string g_strWebMallURL = "forum.turkmmo.comm";
...
/*
 * NOTE : �� üũ On/Off. CheckIn�Ҷ� false�� ���������� �ݵ�� Ȯ���ϰ� ���ĳ�����!
 * �̰ɷ� ������ִ� ���� å�Ӿ��� ~ ity ~
 */
