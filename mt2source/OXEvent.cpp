...
EVENTFUNC(oxevent_timer)
{
	...
	{
	case 0:
		SendNoticeMap(LC_TEXT("10�ʵ� �����ϰڽ��ϴ�."), OXEVENT_MAP_INDEX, true);
		flag++;
	...
	case 1:
		...
		SendNoticeMap(LC_TEXT("5�� �� Ʋ���� �е��� �ٱ����� �̵� ��Ű�ڽ��ϴ�."), OXEVENT_MAP_INDEX, true);
	...
	case 2:
		...
		SendNoticeMap(LC_TEXT("���� ���� �غ����ּ���."), OXEVENT_MAP_INDEX, true);
		flag = 0;
		break;
	}
	return 0;
...
bool COXEventManager::Quiz(unsigned char level, int timelimit)
{
	...
	SendNoticeMap(LC_TEXT("������ O, Ʋ���� X�� �̵����ּ���"), OXEVENT_MAP_INDEX, true);
