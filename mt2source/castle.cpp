...
EVENTFUNC(castle_siege_event)
{
	...
	{
		snprintf(buf, sizeof(buf), LC_TEXT("%s���� ��ȭ�� �ѷ��ΰ� ������ �������Դϴ�."),
	...
	{
		snprintf(buf, sizeof(buf), LC_TEXT("%s�� ������ �����߽��ϴ�."), EMPIRE_NAME(GET_SIEGE_EMPIRE()));
		BroadcastNotice(buf);

		snprintf(buf, sizeof(buf), LC_TEXT("���ݺ��� %s�� 30�а� ��ȭ�� �ı��Ͽ� ������ ȹ�� �� �� �ֽ��ϴ�."), EMPIRE_NAME(GET_SIEGE_EMPIRE()));
		BroadcastNotice(buf);
	...
	case CASTLE_SIEGE_END:
		BroadcastNotice(LC_TEXT("30���� ����߽��ϴ�.. ��ȭ�� ������ϴ�."));
		castle_end_siege();
		break;
	}
	return 0;
...
bool castle_spawn_tower(int empire, int tower_count)
{
	...
	{
		char buf[1024];
		snprintf(buf, sizeof(buf), LC_TEXT("%s�� ������ ������ �˸��� ��ȭ�� ��Ÿ�����ϴ�."), EMPIRE_NAME(empire));
		BroadcastNotice(buf);
	}
	return true;
}
...
void castle_tower_die(LPCHARACTER ch, LPCHARACTER killer)
{
	...
	{
		int	siege_end = true;
		snprintf(buf, sizeof(buf), LC_TEXT("%s�� ��ȭ�� �ı��߽��ϴ�."), EMPIRE_NAME(killer_empire));
		BroadcastNotice(buf);
		...
		if (siege_end)
		{
			...
			{
				snprintf(buf, sizeof(buf), LC_TEXT("%s�� ������ �����Ͽ� ���￡ �й��Ͽ����ϴ�.."), EMPIRE_NAME(GET_SIEGE_EMPIRE()));
				BroadcastNotice(buf);
			}
			else
			{
				snprintf(buf, sizeof(buf), LC_TEXT("%s�� ��� ��ȭ�� �ı��Ͽ����ϴ�."), EMPIRE_NAME(GET_SIEGE_EMPIRE()));
				BroadcastNotice(buf);
			}
			castle_end_siege();
		}
