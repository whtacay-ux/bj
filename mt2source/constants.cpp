 ...
 */
{
	...
	{	6,	4,	3,	3,	700,	700,	40,	40,	36,	44,	18,	22,	800,	5,	1,	3	}, // JOB_WARRIOR 16
	{	4,	3,	6,	3,	700,	700,	40,	40,	36,	44,	18,	22,	800,	5,	1,	3	}, // JOB_ASSASSIN 16
	{	5,	3,	3,	5,	700,	700,	40,	40,	36,	44,	18,	22,	800,	5,	1,	3	}, // JOB_SURA 16
	{	3,	4,	3,	6,	700,	700,	40,	40,	36,	44,	18,	22,	800,	5,	1,	3	}, // JOB_SHAMAN 16
#ifdef ENABLE_WOLFMAN_CHARACTER
	{	2,	6,	6,	2,	700,	700,	40,	40,	36,	44,	18,	22,	800,	5,	1,	3	}, // JOB_WOLFMAN 16
#endif
};
 ...
 */
{
	...
	{ POINT_NONE,					},	// APPLY_ATTBONUS_WOLFMAN,		94 ���������� ����
	{ POINT_NONE,					},	// APPLY_RESIST_WOLFMAN,		95 ���������� ����
	{ POINT_NONE,					},	// APPLY_RESIST_CLAW,			96 CLAW���� ����
#endif
	...
	{ POINT_RESIST_HUMAN,					}, //APPLY_RESIST_HUMAN,105
	{ POINT_NONE,							}, //APPLY_MOUNT,106
};
...
TValueName c_aApplyTypeNames[] =
{
	...
	{ "POINT_ENCHANT_EARTH", APPLY_ENCHANT_EARTH }, //100
	{ "POINT_ENCHANT_ELECT", APPLY_ENCHANT_ELECT }, //101
	{ "POINT_ENCHANT_FIRE", APPLY_ENCHANT_FIRE }, //102
	{ "POINT_ENCHANT_ICE", APPLY_ENCHANT_ICE }, //103
	{ "POINT_ENCHANT_WIND", APPLY_ENCHANT_WIND }, //104
	{ "POINT_RESIST_HUMAN", APPLY_RESIST_HUMAN}, //105
	{ "POINT_NONE", APPLY_MOUNT }, //106
	{ NULL,		0			}
};
